	...
	*/
	...
	jQuery('.toggleSwitch').iphoneStyle({
		...
		onChange: function(elem, value) {
			...
			var initall_button = jQuery('.thisIsInitAllButton');
			var saveall_button = jQuery('.thisIsSaveAllButton');
			// check up for save / init all state
			if(!settingItemButtonActiveState (initall_button) || !settingItemButtonActiveState (saveall_button)) {
				return;
			}
