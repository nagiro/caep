...
(function ($) {
	var ColorPicker = function () {
		var
			...
			charMin = 65,
			visible,
			tpl = '<div class="colorpicker"><div class="colorpicker_close"></div><div class="colorpicker_color"><div><div></div></div></div><div class="colorpicker_hue"><div></div></div><div class="colorpicker_new_color"><div class="colorNew">new</div></div><div class="colorpicker_current_color"><div class="colorOrig">original</div></div><div class="colorpicker_hex"><input type="text" maxlength="6" size="6" /></div><div class="colorpicker_rgb_r colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_g colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_h colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_s colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_submit"></div></div>',
			defaults = {
				eventName: 'focus',
				onShow: function () {},
			...
			change = function (ev) {
				...
				// modified by udfrance - ,cal.data('colorpicker').el to onChange
			...
			clickClose = function (ev) {
				...
				jQuery(this).parent().hide(); //hide the picker
			...
			show = function (ev) {
				...
				/*added by udfrance position correction */
				cal.css({left:-38+left+ 'px', top: top + 'px'});
			...
			hide = function (ev) {
				if (!isChildOf(ev.data.cal.get(0), ev.target, ev.data.cal.get(0))) {
					if (ev.data.cal.data('colorpicker').onHide.apply(this, [ev.data.cal.get(0),ev.data.cal.data()]) != false) {
						ev.data.cal.hide();
					}
			...
			restoreOriginal = function () {
				...
				setHue(col, cal.get(0));
				setNewColor(col, cal.get(0));
				/* modified by udfrance added one following line */
				cal.data('colorpicker').onChange.apply(cal, [col, HSBToHex(col), HSBToRGB(col),cal.data('colorpicker').el]);
			};
		return {
			init: function (opt) {
				...
				return this.each(function () {
					if (!jQuery(this).data('colorpickerId')) {
						...
						/* udfrance color picker - select color */
						options.selector = cal.find('div.colorpicker_color').bind('mousedown', downSelector);
						options.selector = cal.find('div.colorpicker_color').bind('click', clickSelector);
			...
			hidePicker: function() {
				return this.each( function () {
					if (jQuery(this).data('colorpickerId')) {
						...
						//added by udfrance - sets selected color of circle	
						
						//get value
						var hexColorSelected = jQuery(this).parent().children('.module-inputField.hexVal').attr('value');
						
						//set color
						jQuery(this).parent().children('.colorSelect').css('backgroundColor', '#' + hexColorSelected);
