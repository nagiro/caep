...
array_push($FSA_shortcode_info['Media']['shortcode_data'],
	array(
		...
		'attributes' => array (
				...
				'caption_width' => '',
				'caption_align' => array('top-left','center-left','bottom-left','top-right','center-right','bottom-right','top-center','bottom-center','center'),
				'link' => '',
				'link_title' => '',
				'style' => ''
			),
...
array_push($FSA_shortcode_info['UI']['shortcode_data'],
	array(
		...
		'attributes' => array (
				...
				'color'=>array('theme','blue','dark-gray','gray','green','navy','orange','purple','red','turquoise','white','yellow'),
...
array_push($FSA_shortcode_info['UI']['shortcode_data'],
	array(
		...
		'is_block_level' => null,
		'description'=>'To create a table please add the pricing_table_column shortcode for columns and unordered lists for table rows.<br>To insert a pricing_table_column shortcode into the textarea below please <a onclick=\\\'jQuery("#moduleSection_pricing_table textarea").val(jQuery("#moduleSection_pricing_table textarea").val()+"[pricing_table_column]<ul><li>Table Row</li></ul>[\/pricing_table_column]\\\n");\\\' href="javascript:void(0);">click here.</a>',
